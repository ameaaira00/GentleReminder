...
function fetchReminders() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch('reminders.json')];
                case 1:
                    response = _a.sent();
...
function displayReminder() {
    return __awaiter(this, void 0, void 0, function () {
        var reminders, date, day, reminder, color, titleElement, textElement, containerElement;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetchReminders()];
                case 1:
                    reminders = _a.sent();
                    date = new Date();
                    day = date.getDate() - 1;
                    reminder = reminders[day % reminders.length];
                    color = pastelColors[day % pastelColors.length];
                    titleElement = document.getElementById("reminder-title");
                    textElement = document.getElementById("reminder-text");
                    containerElement = document.getElementById("reminder-container");
